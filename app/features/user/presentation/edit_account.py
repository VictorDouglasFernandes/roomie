...
class EditAccount:
    def __init__(self, controller):
        ...
        self.__user = self.controller.user
        self.user = None
        self.raiz = Tk()
        self.tela()
        self.entrada()
    ...
    def entrada(self):
        ...
        self.name_var = StringVar(self.frame_2, value=self.__user.name)
        self.entrada_name = Entry(self.frame_2, bg='#f4bc44', fg='white', textvariable=self.name_var)
        ...
        self.surname_var = StringVar(self.frame_2, value=self.__user.surname)
        self.entrada_surname = Entry(self.frame_2, bg='#f4bc44', fg='white', textvariable=self.surname_var)
        ...
        self.birthday_var = StringVar(self.frame_2, value=self.__user.birthday)
        self.entrada_birthday = Entry(self.frame_2, bg='#f4bc44', fg='white', textvariable=self.birthday_var)
        ...
        self.sex_var = StringVar(self.frame_2, value=self.__user.sex)
        self.entrada_sex = Entry(self.frame_2, bg='#f4bc44', fg='white', textvariable=self.sex_var)
        ...
        self.cpf_var = StringVar(self.frame_2, value=self.__user.cpf)
        self.entrada_cpf = Entry(self.frame_2, bg='#f4bc44', fg='white', textvariable=self.cpf_var)
        ...
        self.cellphone_var = StringVar(self.frame_2, value=self.__user.cellphone_number)
        self.entrada_cellphone = Entry(self.frame_2, bg='#f4bc44', fg='white', textvariable=self.cellphone_var)
        ...
        self.email_var = StringVar(self.frame_2, value=self.__user.email)
        self.entrada_email = Entry(self.frame_2, bg='#f4bc44', fg='white', textvariable=self.email_var)
        ...
        self.password_var = StringVar(self.frame_2, value=self.__user.password)
        self.entrada_password = Entry(self.frame_2, bg='#f4bc44', fg='white', textvariable=self.password_var)
        self.entrada_password.place(relx=0, rely=0.72, relwidth=0.7, relheight=0.06)

    def botoes(self):
        self.bt_editar = Button(self.frame_1, text="EDITAR", fg='white', bg='#f4bc44', font=('JasmineUPC', 8),
                                command=self.edit)
